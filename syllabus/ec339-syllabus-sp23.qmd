...
\begin{tabular}{ll|l} 
	...
	\textbf{Web:} & \, \faPencil \, \href{https://github.com/marciosantetti/ec339-sp23}{\texttt{Course GitHub Repository}} \\
\end{tabular}
...
Lecture notes and problem sets will be posted on the Course's [`GitHub repository`](https://github.com/marciosantetti/ec339-sp23). Additional readings, quizzes, answer keys, and data files will be uploaded to `theSpring`. Students will also use `theSpring` to submit all assignments.
...
* Ignore emails/requests asking for any change in your grades by the end of the semester.
